...
class Container(FloatLayout):
    ...
    def main_screen(self):
        self.clear_widgets()
        self.load_btn =Button(text="Load", background_color = (250,250,250,1),color=(0,0,0,1), size_hint =(.3, .2), pos_hint={"right":0.32,"top":.75})
        self.load_btn.bind(on_press=self.load_pop_up)
        self.add_widget(self.load_btn)
        self.analysis_btn =Button(text="Analysis",background_color = (250,250,250,1),color=(0,0,0,1),size_hint =(.3, .2),pos_hint={"right":0.32,"top":.53})
        self.analysis_btn.bind(on_press=self.main_analysis)     
        self.add_widget(self.analysis_btn)
        self.graph_btn =Button(text="Graph",background_color = (250,250,250,1),color=(0,0,0,1),size_hint =(.3, .2),pos_hint={"right":0.32,"top":.31})
        self.add_widget(self.graph_btn)
        self.graph_btn.bind(on_press=self.graph_pop_up)
        
        try:
            logo_path_online = "https://github.com//weriko/complexityAnalysis/raw/master/Logo.PNG"
            self.logo_btn =AsyncImage(source=logo_path_online,size_hint =(.7, .2),pos_hint={"right":0.75,"top":.98})
        except:
            logo_path_offline = "Logo.PNG"
            self.logo_btn = kvImage(source=logo_path_offline,size_hint =(.7, .2),pos_hint={"right":0.75,"top":.98})
        ...
        self.dropdown_btn =Button(text="""
               ...
               __  
               __
                                  """,font_size=30,size_hint =(.2, .2),background_color=(0,0,0,0),pos_hint={"right":0.95,"top":1})

        self.add_widget(self.dropdown_btn)
        self.dropdown_btn.bind(on_press=self.help_pop_up)
        self.scrollable_code = ScrollView(size_hint =(.55, 0.64),pos_hint={"right":0.95,"top":0.75})
    ...
    def code_widget(self):
        try:
            ...
            for i in self.code.split("\n"):
                self.grid_widget_code.add_widget(TextInput(text=str(i),size_hint_y=None,readonly=True,foreground_color=(1,1,1,1),background_color= (0,0,0,1)))
        except:
            pass
    ...
    def help_pop_up(self,k):
        ...
        self.help_popup = Popup(title='Menu',content=show,size_hint=(None, None), size=(int(screensize[1]/3.5),int(screensize[0]/5.5)))
    ...
    def open_browser_help(self,k):
        try:
            webbrowser.open('https://github.com/weriko/complexityAnalysis/blob/master/TEST.pdf', new=2)
             ...
             popup = Popup(title='ERROR',content= Label(text="CONNECTION ERROR"))
             popup.open()
    ...
    def graph_pop_up(self,k):
        self.clear_widgets()
        self.scrollable_numeric = ScrollView(size_hint =(.55, 0.9),pos_hint={"right":0.98,"top":0.95})
        ...
        for i in self.functions:
            ...
            btn = Button(text=str(i),background_color = (250,250,250,1),color=(0,0,0,1))
            btn.bind(on_press=self.exec_function)
            show.add_widget(btn)
            temp = TextInput(text=str(i),size_hint_y=None,foreground_color=(1,1,1,1),background_color= (0,0,0,1))
            temp2 = TextInput(text="Range",size_hint_y=None,foreground_color=(1,1,1,1),background_color= (0,0,0,1))
            self.function_texts.append(temp)
            self.function_range.append(temp2)
            show.add_widget(temp)
            show.add_widget(temp2)
        self.aimg2 = kvImage( pos_hint={"right":0.42,"top":0.92} ,allow_stretch= True,keep_ratio= True,size_hint_y=.6,size_hint_x= .4)
        self.add_widget(self.aimg2)
        btn2 = Button(text="Back",background_color = (250,250,250,1),color=(0,0,0,1))
    ...
    def load_pop_up(self,k):
        show = GridLayout(cols=1)
        btn_github = Button(text="Load from Github",background_color = (250,250,250,1),color=(0,0,0,1))
        btn_github.bind(on_press= self.load_github)
        self.github_code_rd = TextInput(text="Raw github link",size_hint_y=None,foreground_color=(1,1,1,1),background_color= (0,0,0,1))
        btn = Button(text="Back",background_color = (250,250,250,1),color=(0,0,0,1))
        btn.bind(on_press=lambda x: self.answers_popup.dismiss())
        btn_path_load= Button(text="Load from Path",background_color = (250,250,250,1),color=(0,0,0,1))
        btn_path_load.bind(on_press= self.load_path)
        self.path_code_rd = TextInput(text="Path",size_hint_y=None,foreground_color=(1,1,1,1),background_color= (0,0,0,1))
        ...
        show.add_widget(btn)
        self.answers_popup = Popup(title="Load",content=show)
        self.answers_popup.open()
    ...
    def main_analysis(self,k):
        ...
        self.clear_widgets()
        self.scrollable_dis = ScrollView(size_hint =(.55, 0.9),pos_hint={"right":0.98,"top":0.95})
        ...
        for i in datatemp.split("\n"):
                self.grid_widget_dis.add_widget(TextInput(text=str(i),size_hint_y=None,foreground_color=(1,1,1,1),background_color= (0,0,0,1),readonly=True))
        cmplx = self.get_loops()
        self.complexity_output =  TextInput(text=str("O(n^"+str(cmplx)+")"),foreground_color=(1,1,1,1),background_color= (0,0,0,1),font_size=20,size_hint=(0.1,0.05),pos_hint={"right":0.3,"top":0.95},readonly=True)
        ...
        plt.close()
        self.aimg = kvImage(pos_hint={"right":0.42,"top":0.92},allow_stretch= True,keep_ratio= True,size_hint_y=.6,size_hint_x= .4)
        self.aimg.source = "temp1.jpg"
        self.aimg.reload()
        self.go_back_btn = Button(text="Back",size_hint =(.2, .1),pos_hint={"right":0.32,"top":.2},background_color = (250,250,250,1),color=(0,0,0,1))
